...
class _TeamDetailPageState extends State<TeamDetailPage> with SingleTickerProviderStateMixin {
  ...
  void _enableEditing(Team team) async {
    ...
    coach_service.Coach? assignedCoach = team.manager;
    setState(() {
    ...
    return Scaffold(
      body: FutureBuilder<Team>(
        ...
        builder: (context, teamSnapshot) {
              ...
              child: SingleChildScrollView(
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      // Editable fields (name, short name, logo, founded, coach assignment)
                      TextField(
                      ...
                      _loadingCoaches
                        ...
                        : DropdownButtonFormField<coach_service.Coach?>(
                            ...
                            items: [
                              const DropdownMenuItem<coach_service.Coach?>(
                                value: null,
                                child: Text('No Coach'),
                              ),
          ...
          // --- OTHERWISE SHOW RICH PROFILE UI ---
